...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='MS', data_path='CO2.csv',
                 target=['lower', 'upper'], scale=True, timeenc=0, freq='m', embed='timeF'):
    ...
    def __read_data__(self):
        ...
        self.num_test = int(len(df_raw) * 0.1)
        ...
        if self.timeenc == 0:
            ...
            df_stamp = df_raw[['date', 'month_sin', 'month_cos']][border1:border2].copy()
            df_stamp['date'] = pd.to_datetime(df_stamp.date)
...
class Dataset_Pred(Dataset):
    def __init__(self, root_path, flag='pred', size=None,
                 features='MS', data_path='ChiangSaen.csv',
                 target='spi_6', scale=True, inverse=False, timeenc=2, freq='m', cols=None):
        self.seq_len = size[0]
